...
namespace FishingSystem
{
    ...
    public class FishingManager : MonoBehaviour
    {
        ...
        [Tooltip("Local offset applied to the minigame root, relative to the player. " +
                 "Tweak in the inspector so the UI sits where you want it on screen.")]
        ...
        private void LateUpdate()
        {
            ...
            // any animation root motion / camera adjustments.
            if (_isFishing && _followTarget != null && minigameRoot != null)
            {
                minigameRoot.transform.position = _followTarget.position + uiOffsetFromPlayer;
            }
        }
        ...
        public bool StartFishing(Transform player, System.Action<bool> onComplete)
        {
            ...
            // others can read from it (progress bar reads targetPoints).
